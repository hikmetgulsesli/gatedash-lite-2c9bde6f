...
- GateDash Lite turns the user's request into a directly usable game workflow. The first experience must be the actual browser game behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser-game called GateDash Lite. It should be a full-viewport arcade timing game where the player dashes a glowing chip through moving gates, collects cyan sparks, avoids amber hazards, has a settings overlay, pause/resume, score, level, and clear keyboard/click controls. Keep it small but…
...
- Gameplay - GateDash Lite
- Game Settings - GateDash Lite

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Gameplay - GateDash Lite
...
SCREEN_SPEC_2:
- exact_screen_title: Game Settings - GateDash Lite
